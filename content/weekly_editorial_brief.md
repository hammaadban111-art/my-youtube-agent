...
1. Read this brief before researching or drafting any story.
2. Never repeat a subject in avoid_subjects. The packet validator is the final duplicate gate.
3. Use strong and weak hook examples for structure only when the brief says hook evidence is sufficient. They come from the top early-performance cohort above the throttle floor, not high-retention low-distribution clips.
4. Use frozen_views for early-performance comparisons and latest_views only as directional mature evidence.
5. Treat low-signal examples as questions to avoid or test, not proof that an entire topic category cannot work.
...
- **The Unsinkable Ghost Ship That Lost 25 People** — `MV Joyita`; latest 1,099, frozen 1,052, hook 81.0%
...
- **The Walking Rocks of Death Valley Solved** — `Sailing stones`; latest 1,206, frozen 1,105, hook 125.7%
  - Opening: Giant boulders move across this dry lakebed all by themselves. Deep trails stretch behind rocks weighing seven hundred pounds.
...
- **The Giant Holes Exploding Out of Frozen Siberia** — `Yamal Peninsula`; latest 883, frozen 844, hook 52.0%
...
- **The Silent Lake That Erased an Entire Valley Overnight** — `Lake Nyos disaster`; latest 809, frozen 1, hook 76.3%
- **The 170-Year Arctic Mystery Solved by Local Knowledge** — `Franklin's lost expedition`; latest 1,206, frozen 4, hook 68.6%
- **The Ocean Sound That Terrified Scientists** — `The Bloop`; latest 48, frozen 5, hook 223.8%
- **The 2,000-Year-Old Computer Found at the Bottom of the Ocean** — `Antikythera mechanism`; latest 174, frozen 5, hook 63.3%
